...
profile = ProfileReport(df, title="EDA Train Dataset", explorative=True)
profile.to_file("train_eda_report.html")
print("\nReporte EDA generado: train_eda_report.html")
...
print("\nArchivo final guardado como: train_clean.csv")